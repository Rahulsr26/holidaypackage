...
if ($action=="addnew") {
    ...
    if ($_FILES["CoverImage"]["name"]=="") { 
        $error=1;
        $errornote .= "<li>Please upload cover image</li>";
    }else {        
    ...
    if ($error=="1") {
        ...
        $sql .= "CreatedOn='".date("Y-m-d H:i:s")."', ";
        $sql .= "UpdatedOn='".date("Y-m-d H:i:s")."', ";
        $sql .= "FixedDeparture='".mysqli_real_escape_string($con,$FixedDeparture)."', ";
        // $timestamp = strtotime($FixedDeparture);
        $sql .= "Facilities='".mysqli_real_escape_string($con,$FacilitiesValues)."',  Status=1";
        ...
        if (!mysqli_query($con,$sql)) {
            ...
            header("location: add-package?result=success");
            die();
        }
...
<head>
    <meta charset="utf-8" />
    <title>Add Holiday Package - <?=PROJECT_TITLE?></title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <? if ($_REQUEST['result']=="success") { ?> 
                                    <div class="alert alert-success">Holiday package has been successfully published.</div>
                                <? } ?> 
                                <? if ($error=="1") { ?> 
                                ...
                                <form class="form-horizontal" action="<?=$_SERVER['PHP_SELF']?>?action=addnew" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="PackageTitle" id="PackageTitle" placeholder="Eg. Singapore, Malaysia 5 night 6 days all inclusive" required>
                                        </div>
                                    </div>
                                    ...
                                    <small>You can also add multiple destinations by separating them with commas.</small></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="Destinations tagsinputs" data-role="tagsinput" multiple class="form-control"name="Destinations" id="Destinations" placeholder="Eg. Singapore, Malaysia" required  value="<?php $FixedDeparture?>">
                                            <!-- <script>
                                                 $("#Destinations"){
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control allow_decimal" name="Price" id="Price" placeholder="" maxlength="10" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control datess" name="FixedDeparture" id="FixedDeparture" placeholder="Dates" required autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <label><input type="checkbox" name="Facilities[]" value="Flights"> Flights </label><br>
                                            <label><input type="checkbox"  name="Facilities[]" value="Hotels"> Hotels</label> <br>
                                            <label><input type="checkbox"  name="Facilities[]" value="Food"> Food</label> <br>
                                            <label><input type="checkbox"  name="Facilities[]" value="Transfers"> Transfers</label> <br>
                                            <label><input type="checkbox"  name="Facilities[]" value="Activities"> Activities </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea id="overview" class="form-control" name="Overview" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea id="inclusions" class="form-control" name="Inclusions" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea id="exclusions" class="form-control" name="Exclusions"></textarea>
                                        </div>
                                    </div>
